        ...
        <div className="w-full md:w-7/12 p-10 lg:p-16 flex flex-col justify-center">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end pr-1">
              <button type="button" className="text-sm font-bold text-[#F59E0B] hover:text-[#d97706] transition-all hover:underline decoration-2 underline-offset-4" onClick={() => Navigate("/resetpassword")}>
                Forgot password?
              </button>
            </div>
